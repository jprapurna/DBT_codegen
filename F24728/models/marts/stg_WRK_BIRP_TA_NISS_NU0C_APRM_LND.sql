...
SELECT
"NISS_APRM_LND_SK" AS niss_aprm_lnd_sk, -- Surrogate key for NISS APRM landing
...
"GRGNG_ZIP" AS grgng_zip, -- Garaging ZIP code
...
"MIS_LOB" AS mis_lob, -- Miscellaneous line of business
