...
FROM seqtrans
JOIN lkp_ff_ref_niss_state_cd ON seqtrans.currval = lkp_ff_ref_niss_state_cd.NISS_STATE_CODE
JOIN lkp_ref_tfarmers_state ON lkp_ff_ref_niss_state_cd.FARMERS_STATE_NAME = lkp_ref_tfarmers_state.FARMERS_STATE_CD
JOIN lkp_rbi_ref_auto_terr_bystziplob ON lkp_ref_tfarmers_state.STATE_CODE = lkp_rbi_ref_auto_terr_bystziplob.NISS_TERR_CD
JOIN mplt_abc_mapping_audit ON lkp_rbi_ref_auto_terr_bystziplob.NISS_TERR_CD = mplt_abc_mapping_audit.WRK_FLOW_RUN_ID
