...
"MINI_RDRVR_SK" AS mini_rdrvr_sk, -- Mini rated driver surrogate key
...
"PNI_SK" AS pni_sk, -- Policyholder surrogate key
"AGT_SK" AS agt_sk, -- Agent surrogate key
"RDRVR_SK" AS rdrvr_sk, -- Rated driver surrogate key
...
"MINI_PNI_SK" AS mini_pni_sk, -- Mini policyholder surrogate key
...
FROM {{ source('POWER_CENTER', 'FACT_AG_WRITTN_PREM_CVG_LVL') }}