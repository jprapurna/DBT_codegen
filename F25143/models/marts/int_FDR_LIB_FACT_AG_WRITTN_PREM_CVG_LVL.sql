...
-- Source Qualifier for fetching data from AGDM Source with SQL Override.
SELECT *
FROM (
  SELECT
    REG_PER_YR,
...
The above code block contains DBT models for the first few sources. Let me know if you need the remaining models or any adjustments.