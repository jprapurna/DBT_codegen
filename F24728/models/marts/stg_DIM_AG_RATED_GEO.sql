...
SELECT
"RATED_GEO_SK" AS rated_geo_sk, -- Surrogate key for rated geographic
"CHK_SUM_ATTR" AS chk_sum_attr, -- Checksum attribute
"GRGNG_ZIP_3" AS grgng_zip_3, -- Garaging ZIP code (3 digits)
"GRGNG_ZIP_5" AS grgng_zip_5, -- Garaging ZIP code (5 digits)
"GRGNG_ZIP_PLUS4" AS grgng_zip_plus4, -- Garaging ZIP code plus 4
...
FROM {{ source('POWER_CENTER', 'DIM_AG_RATED_GEO') }}